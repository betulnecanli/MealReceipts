...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mealModelArrayList.add(new MealModel("Kale/Lemon Sandwiches","We had been traveling " +
        ...
        mealModelArrayList.add(new MealModel("Mango-Lime Bean Salad","Everyone loves this, " +
        ...
        mealModelArrayList.add(new MealModel("Sweet Potato and Lentil Soup with Shiitake Mushrooms",
        ...
        mealModelArrayList.add(new MealModel("Lime Mousse","This is FABULOUS alone, " +
        ...
        mealModelArrayList.add(new MealModel("Red lentil and dill soup with mint",
        ...
        mealModelArrayList.add(new MealModel("Fresh fig and arugula salad",
        ...
        mealModelArrayList.add(new MealModel("Cucumber and kale open-faced sandwich",
        ...
        MealAdapter foodsAdapter = new MealAdapter(this,mealModelArrayList);
